...
class FewShotModel(nn.Module):
    ...
    def forward(self, x, attributes = None, get_feature=False):
        if get_feature:
            ...
            if self.training:
                logits, logits_reg= self._forward(instance_embs, attributes, support_idx, query_idx)
                return logits, logits_reg
            else:
                logits = self._forward(instance_embs, attributes, support_idx, query_idx)
                return logits
