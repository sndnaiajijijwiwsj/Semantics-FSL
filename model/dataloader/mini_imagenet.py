...
import numpy as np
from SPOT import SPOT_GreedySubsetSelection
...
IMAGE_PATH1 = osp.join(ROOT_PATH, 'data/images/images')
SPLIT_PATH = osp.join(ROOT_PATH, 'data/images/split')
...
class MiniImageNet(Dataset):
    ...
    def parse_csv(self, csv_path,setname):
        ...
        if index is not None:
            index_lines=[lines[i] for i in index]
