...
def get_command_line_parser():
    ...
    parser.add_argument('--episodes_per_epoch', type=int, default=60)
    parser.add_argument('--num_eval_episodes', type=int, default=50)
    parser.add_argument('--num_test_episodes', type=int, default=50)
    parser.add_argument('--model_class', type=str, default='CombinedProtoNet')
    ...
    # CombinedPNet Parameters
    parser.add_argument('--num_acc', type=int, default=1)
    parser.add_argument('--vis_rate', type=float, default=1.0)
    ...
    parser.add_argument('--init_weights', type=str, default="/home/wangyin/semantic_driven//max_acc.pth")
    parser.add_argument('--bestsave', type=str, default="/home/wangyin/semantic_driven")
